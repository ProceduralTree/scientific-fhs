...
let
  ...
  nvidia_envvars = ''
    ...
    export LD_LIBRARY_PATH=${pkgs.cudaPackages.cudatoolkit}/lib:${pkgs.cudaPackages.cudnn}/lib:${pkgs.cudaPackages.cudatoolkit.lib}/lib:${pkgs.zlib}/lib:$LD_LIBRARY_PATH
